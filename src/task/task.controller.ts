...
export class TaskController {
  ...
  @ApiParam({ name: 'id', description: 'Task ID', example: '641d1234567890abcdef1234' })
  ...
  @ApiParam({ name: 'id', description: 'Task ID', example: '641d1234567890abcdef1234' })
  @ApiResponse({ status: 200, description: 'Task updated successfully', type: Object })
  @ApiResponse({ status: 404, description: 'Task not found' })
  ...
  @ApiParam({ name: 'id', description: 'Task ID', example: '641d1234567890abcdef1234' })
  @ApiResponse({ status: 200, description: 'Task deleted successfully', type: Object })
  @ApiResponse({ status: 404, description: 'Task not found' })
